...
set_property PACKAGE_PIN U1 [get_ports {tx_full_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tx_full_sw}]
set_property PACKAGE_PIN T1 [get_ports {rx_empty_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rx_empty_sw}]
set_property PACKAGE_PIN R2 [get_ports {tx_done_tick_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tx_done_tick_sw}]
...
set_property PACKAGE_PIN P1 [get_ports {rd}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rd_led}]
set_property PACKAGE_PIN L1 [get_ports {wr}]					
